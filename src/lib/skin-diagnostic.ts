...
export function buildSkinDiagnosticPrompt() {
...
- top_priority: la plus importante. Si face_detected: false, mets "dehydration".
- summary: observation courte et prudente. Si face_detected: false, mets "Aucun visage detecte."
